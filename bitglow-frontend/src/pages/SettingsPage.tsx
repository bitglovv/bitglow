...
export default function SettingsPage() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-black text-white selection:bg-brand/30">
      ...
      <main className="mx-auto flex min-h-screen w-full max-w-5xl flex-col overflow-y-auto px-4 pb-[max(20px,env(safe-area-inset-bottom,20px))] custom-scrollbar sm:px-6 sm:pb-8">
